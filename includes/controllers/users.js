  ...
  async function getUserFull(id) {
            ...
            var returnPromise = new Promise(function (resolve, reject) {
              ...
              rejectFunc = reject;
                ...
                try {
                if (!global.account || !global.account.accessToken) return resolveFunc({ error: 1, data: {} });
                ...
                if (e) return resolveFunc({ error: 1, data: {} });
                    var t;
                    try { t = JSON.parse(i); } catch (err) { return resolveFunc({ error: 1, data: {} }); }
                    if (!t || t.error) return resolveFunc({ error: 1, data: {} });
                    var dataUser = {
                        error: 0,
                        author: 'D-Jukie',
                        data: {
