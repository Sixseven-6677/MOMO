...
// bluebird replacement - use native promises
var bluebird = {
  promisify: function(fn) { return util.promisify(fn); },
  delay: function(ms) { return new Promise(function(resolve) { setTimeout(resolve, ms); }); },
  try: function(fn) { return new Promise(function(resolve, reject) { try { resolve(fn()); } catch(e) { reject(e); } }); }
};
